...
#define STATE_IP_LENGTH_PART 2
#define STATE_IP_LENGTH_POS 3
#define STATE_IP_LENGTH_WRITTEN 4
#define STATE_IP_CSUM_POS 5
#define STATE_IP_CSUM_CLEAR 6
#define STATE_CSUM_CALCULATING 7
#define STATE_CSUM_CALCULATING_2 8
#define STATE_CSUM_CALCULATED 9
#define STATE_CSUM_READ_1 10
#define STATE_CSUM_READ_2 11
#define STATE_CSUM_READ_3 12
#define STATE_CSUM_READ 13
#define STATE_IP_CSUM_POS_2 14
#define STATE_IP_CSUM_WRITTEN 15
#define STATE_UDP_LENGTH_POS 16
#define STATE_UDP_LENGTH_WRITTEN 17
#define STATE_ETXNDL_SET 18
#define STATE_ETXNDH_SET 19
#define STATE_TRANSMITTING 20
#define STATE_TRANSMITTING_2 21
